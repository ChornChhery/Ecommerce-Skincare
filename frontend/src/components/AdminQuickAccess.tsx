  ...
  return (
    <>
      ...
      <button
        ...
        title={t('quick_admin_access', 'Quick Admin Access')}
      >
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 transform transition-all">
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-2">{t('quick_admin_access', 'Quick Admin Access')}</h3>
                <p className="text-slate-600 text-sm">{t('access_admin_panel_with_demo_credentials', 'Access admin panel with demo credentials')}</p>
              </div>
              ...
              <div className="bg-slate-50 rounded-lg p-4 mb-6">
                <h4 className="font-semibold text-slate-800 mb-2">{t('demo_admin_credentials', 'Demo Admin Credentials')}</h4>
              ...
              <div className="flex space-x-3">
                ...
                >
                  {loading ? (
                    ...
                    t('login_as_admin', 'Login as Admin')
                  )}
                </button>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-slate-200 text-center">
                <p className="text-xs text-slate-500 mb-2">{t('or_login_manually', 'Or login manually')}:</p>
                <button
                  onClick={() => {
                    setIsOpen(false);
                ...
                >
                  {t('go_to_admin_login_page', 'Go to Admin Login Page')} →
                </button>
              </div>
            </div>
          </div>
